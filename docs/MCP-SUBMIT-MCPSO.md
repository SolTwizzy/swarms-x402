...
The mcp.so directory (chatmcp/mcpso) is a web-based directory. Their repo is the source code for the website, not a curated list. Submissions go through their web form or community channels.
...
- Discord: https://discord.gg/RsYPRrnyqg
